...
model_folder="/kaggle/working/nmt/model.seq2seq.exp2.phmy"
...
model: /kaggle/working/nmt/model.seq2seq.exp2.phmy/model.npz
max-length: 100
mini-batch: 64
maxi-batch: 100
workspace: 3000
...
beam-size: 6
normalize: 0.6
log: /kaggle/working/nmt/model.seq2seq.exp2.phmy/train.log
valid-log: /kaggle/working/nmt/model.seq2seq.exp2.phmy/valid.log
overwrite: true
keep-best: true
seed: 1111
devices: [0, 1]
