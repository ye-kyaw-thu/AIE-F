...
`hybrid-eliza-mm-bilstm-attention.py` is a hybrid chatbot:
...
```bash
python hybrid-eliza-mm-bilstm-attention.py --mode train --lang mm --data emotions/Combined.csv
```
...
```bash
python hybrid-eliza-mm-bilstm-attention.py --mode chat --lang mm
```
...
```bash
python hybrid-eliza-mm-bilstm-attention.py --mode train --lang mm --epochs 20 --lr 0.0007 --hidden_dim 96 --num_layers 2 --dropout 0.35 --weight_decay 0.0001 --patience 4
```
